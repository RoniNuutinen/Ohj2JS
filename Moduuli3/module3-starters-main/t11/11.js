...
for (let article of picArray) {
  let title = article.title;
  let caption = article.caption;
  let description = article.description;
  let imageLarge = article.image.large;
  let imageMedium = article.image.medium;
  ...
  imgM.src = imageMedium;
  imgM.alt = title;

  let imgCaption = document.createElement("figcaption");
  let imgCaptionText = document.createTextNode(caption);
  imgCaption.appendChild(imgCaptionText);

  let figure = document.createElement("figure");
  figure.appendChild(imgM);
